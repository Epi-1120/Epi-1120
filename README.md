...
Full-stack engineer based in Hong Kong. I build things for fun and to learn.

Day job is TypeScript / React / Next.js. Nights are for security study and the occasional CTF.

**CISA exam passed** (certification pending experience requirement). Currently working through Security+.

### What I'm working on

- [**CertlyForge**](https://certlyforge.web.app) — free cert exam prep (CISA, CISM, Sec+, CCNA, IELTS). Practice questions + mock exams + flashcards. No paywall.
- [**mcp-check**](https://github.com/Epi-1120/mcp-check) — CLI tool to test MCP server connections

### Tech I actually use

TypeScript, React, Next.js, Tailwind, Firebase, Node.js, Python, C++ (for CTF stuff)
